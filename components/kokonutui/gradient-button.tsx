...
const gradientColors: Record<ColorVariant, GradientColors> = {
  blue: {
    dark: {
      border: "from-[#4B77FF] via-[#0C1F21] to-[#2446D8]",
      overlay: "from-[#4B77FF]/40 via-[#0C1F21] to-[#2446D8]/30",
      accent: "from-[#B8C8FF]/10 via-[#0C1F21] to-[#15275D]/50",
      text: "from-[#DDE6FF] to-[#9FB7FF]",
      glow: "rgba(75,119,255,0.1)",
      textGlow: "rgba(159,183,255,0.4)",
      hover: "from-[#15275D]/20 via-[#4B77FF]/10 to-[#15275D]/20",
    },
    light: {
      border: "from-[#5C7CFA] via-[#3B5BDB] to-[#274BDB]",
      base: "from-[#2457ff] via-[#244fff] to-[#1f46dc]",
      overlay: "from-white/10 via-[#6384ff]/20 to-[#153fd1]/20",
      accent: "from-white/20 via-[#6f8eff]/10 to-[#1b44dd]/30",
      text: "from-white to-[#eef2ff]",
      glow: "rgba(36,87,255,0.2)",
      hover: "from-white/20 via-[#7b95ff]/20 to-white/10",
    },
  },
  emerald: {
    dark: {
